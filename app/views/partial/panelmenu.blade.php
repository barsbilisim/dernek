  ...
  <div class="container-fluid">
    ...
    <div class="navbar-collapse collapse">
      <ul class="nav menu navbar-nav">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">ADMIN<b class="caret" style="margin-top:-4px"></b></a>
          <ul class="dropdown-menu">
        ...
        <li class="dropdown">
          <a href="#" class="dropdown-toggle" data-toggle="dropdown">PAYMENTS<b class="caret" style="margin-top:-4px"></b></a>
          <ul class="dropdown-menu">
