...
class ImagesTest extends TestCase
{
	...
	{
		$this->mock = m::mock('Eloquent', 'Image');
	...
	public function testStore()
	{
		...
		$this->assertRedirectedToRoute('images.index');
	}
	...
	public function testStoreFails()
	{
		...
		$this->assertRedirectedToRoute('images.create');
	...
	public function testUpdate()
	{
		...
		$this->validate(true);
		$this->call('PATCH', 'images/1');

		$this->assertRedirectedTo('images/1');
	}
	...
	public function testUpdateFails()
	{
		...
		$this->assertRedirectedTo('images/1/edit');
		$this->assertSessionHasErrors();
		$this->assertSessionHas('message');
	}
