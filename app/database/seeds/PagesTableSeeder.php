	...
	public function run()
	{
		...
		$pages = array(
			...
			'content'    => '<h2>Ortaklar</h2>
							<p><a href="http://wp.jia.kg/" target="_blank"><img alt="" height="76" src="/images/sponsors/jia.png" width="121" /> </a> <a href="http://www.zpress.kg/" target="_blank"> <img alt="" height="89" src="/images/sponsors/zamandash_logo.jpg" width="68" /> </a> <a href="http://kyrgyzclub.org/" target="_blank"> <img alt="" height="81" src="/images/sponsors/kg_club.jpg" width="129" /> </a> <a href="http://egemendik.org/" target="_blank"> <img alt="" height="93" src="/images/sponsors/egemendik_logo.jpg" width="93" /> </a> <a href="http://www.kyrgyzamerican.org/" target="_blank"> <img alt="" height="91" src="/images/sponsors/kyrusass.jpg" width="92" /> </a> <a href="http://kyrgyz.org.ua/" target="_blank"> <img alt="" height="95" src="/images/sponsors/ukr_logo.png" width="94" /></a></p>',
			'lang'       => 'tr',
			'created_at' => date('Y-m-d H:i:s'),
			'updated_at' => date('Y-m-d H:i:s')],
			['id'        => uniqid(),
